...
import editarProducto from '../Request/editarProducto'

const EditarProducto = ({ onClose, productosData }) => {
  const [formData, setFormData] = useState(productosData)
